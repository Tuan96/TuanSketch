...
This is TuanSketch, where you can draw anything you want on a customizable grid. The app also has Light Mode, Dark Mode, and Random Color features.  This works best on PC.  
